<template>
	<view class="X-C X-baseBackgroundColor">
		...
		<view class="X-R X-have-interval X-top X-RautoAdjust X-contentBackgroundColor">
			<view><text class="X-fontspacing" style="color: #1c3f2;">工作人员电话:</text>
			<text class="X-fontspacing" style="color: #1c3f2;"></text></view>
			<view class="X-R" @click="tophone()">
					<text class="X-left X-allCenter X-fontspacing" style="color: #1c3f2;">{{onlywork.handler}}</text>
